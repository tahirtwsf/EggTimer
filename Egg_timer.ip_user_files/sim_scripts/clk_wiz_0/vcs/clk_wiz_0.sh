...
#
# Generated by Vivado on Thu Nov 30 16:43:51 -0500 2023
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../Egg_timer.srcs/sources_1/ip/clk_wiz_0" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../../Egg_timer.srcs/sources_1/ip/clk_wiz_0" \
    "$ref_dir/../../../../Egg_timer.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0_sim_netlist.v" \
  2>&1 | tee -a vlogan.log
