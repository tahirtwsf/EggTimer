...
#
# Generated by export_simulation on Sat Dec 02 17:07:08 -0500 2023
#
################################################################################
...
switch to the './c_counter_binary_down.sh' script.

./c_counter_binary_down.sh -reset_run
...
./c_counter_binary_down.sh -noclean_files

For more information on the script, please type './c_counter_binary_down.sh -help'.
