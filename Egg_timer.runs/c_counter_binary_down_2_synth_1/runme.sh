...
HD_PWD='U:/Lab 9/Egg_timer/Egg_timer.runs/c_counter_binary_down_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log c_counter_binary_down_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source c_counter_binary_down_2.tcl
