...
HD_PWD='U:/Lab 9/Egg_timer/Egg_timer.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Egg_timer.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Egg_timer.tcl -notrace
