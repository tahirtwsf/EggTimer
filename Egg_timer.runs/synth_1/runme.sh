...
HD_PWD='U:/Lab 9/Egg_timer/Egg_timer.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Egg_timer.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Egg_timer.tcl
